...
namespace MultiTierContactList_Project {
    ...
    public partial class Database1DataSet : global::System.Data.DataSet {
        ...
        public partial class ContactDataTable : global::System.Data.TypedTableBase<ContactRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public ContactRow AddContactRow(int Id, string FirstName, string LastName, string Email) {
...
namespace MultiTierContactList_Project.Database1DataSetTableAdapters {
    ...
    public partial class ContactTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Contact] ([Id], [FirstName], [LastName], [Email]) VALUES (@Id," +
                " @FirstName, @LastName, @Email);\r\nSELECT Id, FirstName, LastName, Email FROM Con" +
                "tact WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Contact] SET [Id] = @Id, [FirstName] = @FirstName, [LastName] = @LastName, [Email] = @Email WHERE (([Id] = @Original_Id) AND ([FirstName] = @Original_FirstName) AND ([LastName] = @Original_LastName) AND ([Email] = @Original_Email));
SELECT Id, FirstName, LastName, Email FROM Contact WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::MultiTierContactList_Project.Properties.Settings.Default.Database1ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, FirstName, LastName, Email FROM dbo.Contact";
